...
**Strong match areas:** React.js, Next.js, TypeScript, JavaScript, frontend architecture (SSR/CSR/SSG, Server Components), conversational / AI-native UI
**Moderate match areas:** GraphQL, real-time sockets, Redux Toolkit, Zustand, TanStack Query, Tailwind, Jest, Playwright, Core Web Vitals, GSAP, cloud-management UIs (KubeVirt/OpenStack/Redfish as product surfaces)
**Weak match areas:** Anything not on the resume (do not assume backend, mobile, or infra-admin expertise)
...
**Strong:** Senior frontend / frontend architecture; AI-native and conversational web apps; React/Next.js product delivery
**Moderate:** Fintech/accounting UIs, e-commerce, cloud/infra product UIs, design-system / component-library work
**Entry-level:** Roles requiring deep backend, data science, or native mobile as the core job (not claimed)
...
**Career goals:**
- Senior Frontend Engineer / Senior React–Next.js roles in India (primary search)
- Frontend-led roles with AI-native UI; backend as a supporting strength, not the job title
- Architecture, reusable systems, and production-grade product delivery

**Motivation filter:** Evaluate not just whether you *can* do the tasks, but whether the tasks will *energize* you. Consider:
- Tasks that energize: frontend architecture, AI-native UI, DX/maintainability (from resume emphasis)
- Tasks that drain: **not on resume**
